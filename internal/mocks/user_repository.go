...
// SeedIfEmpty provides a mock function with given fields: ctx
func (_m *UserRepository) SeedIfEmpty(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for SeedIfEmpty")
	}
