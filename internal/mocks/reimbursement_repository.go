...
func (_m *ReimbursementRepository) SubmitReimbursement(ctx context.Context, r domain.Reimbursement) error {
	ret := _m.Called(ctx, r)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.Reimbursement) error); ok {
		r0 = rf(ctx, r)
	} else {
		r0 = ret.Error(0)
	}
