...
func (_m *AttendanceRepository) SubmitAttendance(ctx context.Context, att domain.Attendance) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.Attendance) (int, error)); ok {
		return rf(ctx, att)
	}
	if rf, ok := ret.Get(0).(func(context.Context, domain.Attendance) int); ok {
		r0 = rf(ctx, att)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(context.Context, domain.Attendance) error); ok {
		r1 = rf(ctx, att)
	} else {
		r1 = ret.Error(1)
	}
